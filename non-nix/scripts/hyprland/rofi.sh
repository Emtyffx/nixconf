...
calc)
  ...
  ;;
clipboard)
  r_override="entry{placeholder:'Search clipboard...';}listview{lines:15;}"
  rofi_theme="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/launchers/type-2/style-2.rasi"

  pkill rofi || rofi -modi clipboard:"${XDG_CONFIG_HOME:-$HOME/.config}/hypr/scripts/cliphist-rofi-img"  -show clipboard -show-icons -theme "${rofi_theme}" -theme-str "$r_override"
  ;;
help | --help)
